...
const Home: NextPage<{ folders: FolderType[]; notesArr: DBNoteType[] }> = ({
  folders,
  notesArr,
}: {
  folders: FolderType[];
  ...
  const notes = noteHelper(notesArr);
  return (
    <div>
      <Head>
...
export const getServerSideProps: GetServerSideProps = async (
  ...
  const notesArr = await notesRes.json().then((note) => note.notes);

  return {
      props: { folders, notesArr }, // will be passed to the page component as props
  };
};
